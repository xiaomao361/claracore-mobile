...
1. Run the local automated readiness gate:
   ...
   This verifies the public fallback Privacy Policy and Support URLs, plist/project syntax, the PrivacyInfo manifest, App Store icon size/alpha, App Store Connect metadata lengths/placeholders, common secret patterns, Release simulator build, bundled privacy manifest, bundle identifier/version, and `ITSAppUsesNonExemptEncryption = false`.
